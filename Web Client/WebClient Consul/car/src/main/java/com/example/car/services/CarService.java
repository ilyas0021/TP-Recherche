...
public class CarService {
    ...
    // This function allows converting the Car Entity to a model for the client side using the @Builder annotation
    ...
    public CarResponse findById(Long id) throws Exception {
        ...
        Client client = webClientBuilder.build()
                .get()
                .uri(this.URL + "/api/client/" + car.getClient_id())
                .retrieve()
                .bodyToMono(Client.class)
                .block();
